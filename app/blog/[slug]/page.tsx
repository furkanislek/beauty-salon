...
export async function generateMetadata({ params }: BlogPostPageProps) {
  ...
  return {
    title: `${post.title} | Beauty Salon Blog`,
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div className="flex gap-3">
                  <button className="w-10 h-10 rounded-full bg-gray-100 hover:bg-primary-100 text-gray-600 hover:text-primary-600 transition-colors flex items-center justify-center">
                    <svg
                      className="w-5 h-5"
                      fill="currentColor"
                      viewBox="0 0 24 24"
